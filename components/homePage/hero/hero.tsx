  ...
  return (
    <section>
      ...
      <div className="absolute inset-0 opacity-40 -z-10">
        <div className="hidden md:block relative md:top-[467px] left-0 w-72 h-72 bg-[#FFCF00] rounded-full blur-3xl"></div>
      </div>

      {/* Main content */}
      <div className="relative top-[144px] md:top-[250px] md:left-[70px] md:max-w-[95vw]">
        <div className="grid lg:grid-cols-2 items-center justify-center">
          
          {/* Left Content Section */}
          <div className="flex flex-col justify-center space-y-8 lg:pr-8 md:ml-[180px] lg:justify-end   mx-[16px] md:mx-4">
  ...
  <div className="flex flex-row gap-4 w-full ">
    ...
    >
      Login
          ...
          <div className="hidden relative md:flex justify-center md:justify-start">
